package com.example.touch_me.pfe_project.widgets;
...
import com.example.touch_me.pfe_project.R;
...
public class Thermometer extends View {
  ...
  private void init() {
    ...
    mInnerCirclePaint.setStrokeWidth(7f);


    mOuterCirclePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    mOuterCirclePaint.setColor(Color.WHITE);
    mOuterCirclePaint.setStyle(Paint.Style.FILL);
    mOuterCirclePaint.setStrokeWidth(15f);
    ...
    mFirstOuterCirclePaint.setStrokeWidth(30f);
    ...
    mFirstOuterArcPaint.setStrokeWidth(15f);
  ...
  //simulate temperature measurement for now
  private void measureTemperature(boolean state) {
